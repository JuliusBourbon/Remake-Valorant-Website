<x-main>
    ...
    <section class="bg-white dark:bg-gray-900 py-16 lg:py-0">
        <div class="gap-16 items-center h-[14rem] md:h-[16rem] lg:h-auto mx-auto max-w-screen-sxl lg:grid lg:grid-cols-2 lg:pt-10 lg:px-6 sm:flex sm:flex-col">
            <div class="items-center font-light text-gray-500 sm:text-base md:text-lg dark:text-gray-400 text-center lg:text-left">
            ...
            <div class="mt-8">
                <div class="relative h-60 sm:h-80 md:h-96 overflow-hidden">
                    <img class="w-full object-cover hidden lg:block" src="../../img/Jett_Artwork_Full.png" alt="Jett">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-slate-200">
        <div class="mx-auto max-w-screen-xl lg:pt-10 px-6">
    ...
    <section class="bg-red-400 py-16">
        <div class="gap-16 items-center lg:h-[45rem] md:h-[35rem] sm:h-[40rem] mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:pt-10 lg:px-6 sm:flex sm:flex-col">
            <div class="mt-8">
                <div class="grid grid-cols-2 gap-4 lg:static sm:relative">
                    <img class="w-full object-cover hidden lg:block" src="../../img/Viper_Artwork_Full.png" alt="Viper">
                    <img class="w-full object-cover hidden lg:block" src="../../img/Raze_Artwork_Full.png" alt="Raze">
                </div>
            </div>
            <div class="font-light text-white text-center lg:text-left sm:text-base md:text-lg">
                ...
                <p class="p-2 lg:px-2 md:px-5">More than just guns and bullets, you will choose Agents armed with adaptive, agile, and deadly abilities to prove your marksmanship...</p>
                <a href="/agents">
    ...
    <section class="bg-gray-400 py-16">
        <div class="mx-auto gap-16 items-center lg:h-[35rem] md:h-[22rem] sm:h-[17rem] max-w-screen-xl lg:grid lg:grid-cols-2 lg:pt-10 lg:px-6 sm:flex sm:flex-col">
            <div class="font-light text-white sm:text-base text-center lg:text-left md:text-lg">
            ...
            <div class="mt-8 flex justify-center">
                <div class="grid grid-cols-2 gap-4 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg">
                    <img class="w-full scale-[2] object-cover hidden lg:block" src="../../img/Astra_Artwork_Full.png" alt="Astra">
                    <img class="w-full scale-[2.7] object-cover hidden lg:block" src="../../img/Vyse_Artwork_Full.png" alt="Vyse">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-800 py-16">
        <div class="mx-auto h-[23rem] md:h-[32rem] max-w-screen-xl flex flex-col-reverse lg:flex-row items-center gap-16 px-6">
            <div class="w-full lg:w-1/2 hidden md:block">
                <img class="w-full lg:h-auto md:h-[10rem] object-cover rounded-lg shadow-lg" src="https://cmsassets.rgpub.io/sanity/images/dsfx7636/news/bccc7b5f8647a4f654d4bb359247bce6e82c77ab-3840x2160.png?auto=format&fit=fill&q=80&w=1504" alt="Map Example">
            </div>
