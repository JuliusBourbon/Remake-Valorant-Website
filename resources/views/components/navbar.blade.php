<nav class="bg-slate-900 fixed top-0 left-0 right-0 z-50" x-data="{ open: false }">
      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4 md:space-x-6 md:ml-20 lg:space-x-20 lg:ml-32">
            ...
            <a href="/agents" class="{{ request()->is('agents') ? 'bg-red-600 text-white' : 'text-gray-300 hover:bg-red-600 hover:text-white'}} rounded-md px-3 py-2 text-sm font-medium transition-colors duration-300">Agents</a>
  ...
  <div x-show="open" class="md:hidden">
    <div class="space-y-1 px-2 pt-2 pb-3">
      ...
      <a href="/agents" class="{{ request()->is('agents') ? 'bg-red-600 text-white' : 'text-gray-300 hover:bg-red-600 hover:text-white'}} block rounded-md px-3 py-2 text-base font-medium">Agents</a>
